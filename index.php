...
$connectionString = "DefaultEndpointsProtocol=https;AccountName=eririanasubmission;AccountKey=K/z7FSjtWAG0MBqxvI8rpV+PvEDVaLNI7XjKXe+TVOdCb+OIwe7CoFTVPGzYAYQvePlOVgLfWePZGgbOvWJQYw==";
				...
				do {
					foreach ($result->getBlobs() as $blob)
					{
						...
						<tr>
							...
							<td>
								<form action="analisisgambar.php" method="post">
